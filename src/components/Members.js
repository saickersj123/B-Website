        ...
        <div className="box">
          <div className="row gtr-50 gtr-uniform">
            <div className="member-profile">
              <span className="image fit"><img src="/assets/images/pic01.jpg" alt="멤버 1" /></span>
              <h3>박상진</h3>
              <p style={{ fontSize: "0.9em" }}>The Branches 대표,책임관리자</p>
            </div>
            <div className="member-profile">
              <span className="image fit"><img src="/assets/images/임애경.jpg" alt="멤버 2" /></span>
              <h3>임애경</h3>
              <p style={{ fontSize: "0.9em" }}>Html, UI/UX 개발 프론트엔드</p>
            </div>
            <div className="member-profile">
              <span className="image fit"><img src="/assets/images/황은빈.jpg" alt="멤버 3" /></span>
              <h3>황은빈</h3>
              <p style={{ fontSize: "0.9em" }}>Html, UI/UX 개발 프론트엔드</p>
            </div>
